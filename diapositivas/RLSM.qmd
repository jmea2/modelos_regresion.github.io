...
-   Usaremos el dataset **coronary.rds** en formato `R`. 👉 [Descargar coronary.rds](datasets/coronary.rds)\
...
## Regresión Lineal Simple {.smaller}
...
## Modelo de regresión lineal simple con una covariable/predictor categorico
