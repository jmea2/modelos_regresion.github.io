...
library(rio)
library(tidyverse)
coronary <- import("datasets/coronary.dta")
```
...
-   No es un paso mas o final en el analisis estadistico

-   No deberia ser una receta metodologica
...
Los modelos epidemiológicos se utilizan para dos propósitos principales:

1.  Hacer predicciones.
2.  Controlar el factor de confusión (confounding). (Estimar efectos)
...
### Estimaciones (Descriptivas) en subpoblaciones (Mas efientemente)

-   Aplicación de Estimación de prevalencias ajustadas en subpoblaciones (VIH)

## Utilidades y aplicaciones de la Regresión en Epidemiología

Debe ir las aplicaciones del libro de regression methods in biostatistic
